...
import com.example.guiamapas.databinding.ActivityMapactivityBinding;
...
public class Mapactivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Obtener las coordenadas de la ubicación pasada por el Intent
        ...
        // Mover la cámara hacia la ubicación y ajustar el zoom
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(lugar, 15)); // 15 es el nivel de zoom
    }
